...
!((a) => {
  ...
  function f(a) {
    const e = s(this);
    const n = '__jquery_unobtrusive_validation_form_reset';
    if (!e.data(n)) {
      e.data(n, !0);
      try {
      ...
      t ||
        ((t = {
          options: {
            ...
            errorPlacement: () => {
              !function (a, e) {
                const e = s(this).find(`[data-valmsg-for='${u(e[0].name)}']`);
                let n = (n = e.attr('data-valmsg-replace')) ? !1 !== s.parseJSON(n) : null;
            ...
            invalidHandler: () => {
              !function (a, e) {
                const n = s(this).find('[data-valmsg-summary=true]');
                const t = n.find('ul');
                t?.length &&
                  e.errorList.length &&
                  (t.empty(),
            ...
            success: () => {
              !((a) => {
                let e;
                const n = a.data('unobtrusiveContainer');
                n &&
                  ((e = (e = n.attr('data-valmsg-replace')) ? s.parseJSON(e) : null),
  ...
  return (
    (o.unobtrusive = {
      ...
      parse: (a) => {
        const a = s(a);
        const e = a.parents().addBack().filter('form').add(a.find('form')).has('[data-val=true]');
    ...
    (a.addMinMax = function (a, t, i, r, e, n) {
      return this.add(a, [e || 'min', n || 'max'], (a) => {
        const e = a.params.min;
        const n = a.params.max;
        e && n ? l(a, r, [e, n]) : e ? l(a, t, e) : n && l(a, i, n);
      });
    }),
    (a.addSingleVal = function (e, n, t) {
      return this.add(e, [n || 'val'], (a) => {
        l(a, t || e, a.params[n]);
      });
    }),
    o.addMethod('__dummy__', (a, e, n) => !0),
    o.addMethod('regex', function (a, e, n) {
      return !!this.optional(e) || ((e = new RegExp(n).exec(a)) && 0 === e.index && e[0].length === a.length);
    }),
    o.addMethod('nonalphamin', (a, e, n) => {
      let t;
      return (t = n ? (t = a.match(/\W/g)) && t.length >= n : t);
    }),
    o.methods.extension
      ? (a.addSingleVal('accept', 'mimtype'), a.addSingleVal('extension', 'extension'))
    ...
    a.add('equalto', ['other'], (a) => {
      const e = n(a.element.name);
      const e = m(a.params.other, e);
      l(
        a,
        'equalTo',
        s(a.form)
    ...
    a.add('required', (a) => {
      ('INPUT' === a.element.tagName.toUpperCase() && 'CHECKBOX' === a.element.type.toUpperCase()) ||
        l(a, 'required', !0);
    }),
    a.add('remote', ['url', 'type', 'additionalfields'], (t) => {
      const i = { url: t.params.url, type: t.params.type || 'GET', data: {} };
      const r = n(t.element.name);
      s.each((t.params.additionalfields || t.element.name).replace(/^\s+|\s+$/g, '').split(/\s*,\s*/g), (a, e) => {
        const n = m(e, r);
        i.data[n] = () => {
          const a = s(t.form)
            .find(':input')
    ...
    a.add('password', ['min', 'nonalphamin', 'regex'], (a) => {
    ...
    a.add('fileextensions', ['extensions'], (a) => {
